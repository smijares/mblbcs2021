...
# -*- coding: utf-8 -*-
"""
Neural network with hyperprior mblbcs2021
V1.0
...
This script is based on bmshj2018.py by J. Ballé.
...
class BMSHJ2021Model(tf.keras.Model):
  """Main model class."""
...
def parse_args(argv):
  ...
  train_cmd.add_argument(
      "--train_path", default="/tmp/train_bmshj2021",
